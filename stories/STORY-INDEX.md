...
| S-2.03 | S-2.03: Code Context Exclusion and Anchor Table Integrity for Fenced Code Blocks | E-2 | 4 | 5 | P0 | draft | S-2.01 |
...
| S-6.02 | S-6.02: `--allow` URL Prefix Exemption and Invalid-Glob Startup Gate | E-6 | 3 | 8 | P0 | draft | S-6.01 |
| S-7.01 | S-7.01: Exit Code Determination — `verdict::exit_code` | E-7 | 3 | 5 | P0 | draft | S-1.02 |
| S-7.02 | S-7.02: Text Report Generation — `reporter::format_text` + `format_summary` + stdout/stderr separation | E-7 | 2 | 8 | P0 | draft | S-1.01 |
| S-7.03 | S-7.03: JSON Report Generation — `reporter::format_json` + schema stability contract | E-7 | 3 | 5 | P0 | draft | S-7.02 |
