...
|----|-------------|-------------------|
| EC-007 | `mdlinkcheck notes.txt` — non-md explicit arg | Parsed; exit code reflects link findings |
| EC-010 | `mdlinkcheck . docs docs/a.md` (overlapping) | `docs/a.md` scanned once; findings reported once |
| EC-012 | `mdlinkcheck /does/not/exist` | Exit 2; usage-style message on stderr |
