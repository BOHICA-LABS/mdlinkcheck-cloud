...
|--------|----------|-------------|
| VP-019 | Every Tag::Link/Tag::Image outside code context is extracted | property test |
| VP-014 | No Tag::Link/Tag::Image inside code context is extracted | property test |
