...
|----|-------------|-------------------|
| EC-116 | `<https://example.com>` | In scope; syntax-checked |
| EC-117 | Bare `https://example.com` in prose | Not extracted; no findings |
...
| Field | Value |
|-------|-------|
| L2 Capability | CAP-003 ("Distinguish link kinds: ... external-http, non-http") per capabilities.md §CAP-003 |
