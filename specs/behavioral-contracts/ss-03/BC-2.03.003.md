...
|----|-------------|-------------------|
| EC-096 | `[text][nope]` — label never defined | broken (undefined-reference-definition) |
| EC-097 | `[ref]: missing.md` — defined but never used | No error (unused defs not reported) |
