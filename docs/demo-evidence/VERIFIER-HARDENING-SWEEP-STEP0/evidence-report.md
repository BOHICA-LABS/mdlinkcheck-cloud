...
| AC-7 | VEF selftest suite: 50/50 pass (each proved clean-pass + defect-fail) | PASS |
...
- `AC-007-vef-selftest.txt` — VEF selftest suite confirming 50/50 pass
...
VEF selftest suite (`scripts/tests/test-vef.py`): 50/50 pass.
